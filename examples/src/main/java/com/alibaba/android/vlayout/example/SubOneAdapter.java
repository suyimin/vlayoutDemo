...
public class SubOneAdapter extends DelegateAdapter.Adapter<VLayoutActivity.MainViewHolder> {
    ...
    public VLayoutActivity.MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new VLayoutActivity.MainViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_one, parent, false));
    }
